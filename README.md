...
**Source:** [Olist Brazilian E-Commerce Dataset](https://www.kaggle.com/datasets/olistbr/brazilian-ecommerce) from Kaggle
...
- [Netflix ETL Pipeline](https://github.com/EkeminiImeOtu/netflix-etl-pipeline) — Batch pipeline with Airflow, dbt, Snowflake and AWS
- [Netflix Streaming Pipeline](https://github.com/EkeminiImeOtu/netflix-streaming-pipeline) — Real-time pipeline with Kafka, Spark and Snowflake
